...
db.especialidade = require('../api/models/EspecialidadeModel.js')(sequelize, Sequelize); 
...
db.especialidade.belongsTo(db.perfil, {as: 'profissional'});
db.especialidade.belongsTo(db.categoria, {as: 'categoria'});
